const { validateId, validateIdForRemoveComment } = require('../middlewares/validation/validateId');
...
router.route('/remove-comment/:postId/:commentId').delete(validateIdForRemoveComment, verifyToken, deleteComment);
